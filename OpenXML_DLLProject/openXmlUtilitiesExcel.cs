...
{
    public class openXmlUtilitiesExcel
    {
        ...
        public static void GenerateWorkbookPartContent(WorkbookPart workbookPart1)
        {
        ...
        {
            Row tRow = new Row();
            tRow.Append(CreateCell(testmodel.TestId.ToString(), 1));
            tRow.Append(CreateCell(testmodel.TestName, 1));
            tRow.Append(CreateCell(testmodel.TestDesc, 1));
            tRow.Append(CreateCell(testmodel.TestDate.ToShortDateString(), 1));
